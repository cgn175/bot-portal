...
const ALLOWED_FILES = [
  ...
  { name: 'config.toml', label: 'Config', description: 'Agent configuration settings' },
]
        ...
        <div>
          <div className="card" style={{ marginBottom: '1rem' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={saving || !hasChanges || isOverLimit || selectedFile === 'config.toml'}
                >
            ...
            {!showPreview ? (
              <textarea
                ...
                disabled={selectedFile === 'config.yaml'}
                style={{
                  width: '100%',
                  minHeight: '500px',
                  padding: '1rem',
                  ...
                  lineHeight: '1.6',
                  resize: 'vertical',
                  background: isOverLimit ? 'rgba(239, 68, 68, 0.05)' : (selectedFile === 'config.yaml' ? 'var(--color-bg-secondary)' : undefined),
                  color: selectedFile === 'config.toml' ? 'var(--color-text-muted)' : undefined,
                }}
          ...
          <div style={{
            ...
            <p style={{ marginBottom: '0.5rem' }}>
              <strong>Tip:</strong> {selectedFile === 'config.toml'
                ? 'This file is automatically generated by the portal and is read-only.'
                : 'Use Markdown formatting. Changes are saved to the database and synced to running agents automatically.'}
            </p>
            {isNearLimit && selectedFile !== 'config.toml' && (
